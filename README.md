...
To build the final jar and optimize the groupface application for production, run:
...
Then navigate to [http://localhost:9218](http://localhost:9218) in your browser.
