...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTPICS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POSTPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POSTPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTPICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTPICS actions', async () => {
      const expectedActions = [
        {
