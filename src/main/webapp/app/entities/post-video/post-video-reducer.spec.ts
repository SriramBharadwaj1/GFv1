...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTVIDEO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POSTVIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POSTVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTVIDEO actions', async () => {
      const expectedActions = [
        {
