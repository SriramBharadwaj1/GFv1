...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CASTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CASTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CASTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CASTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CASTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CASTE actions', async () => {
      const expectedActions = [
        {
