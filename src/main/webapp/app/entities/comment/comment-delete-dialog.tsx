...
export const CommentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.comment.delete.question">
        <Translate contentKey="groupfaceApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-comment" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
