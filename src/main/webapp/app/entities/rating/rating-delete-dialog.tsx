...
export const RatingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.rating.delete.question">
        <Translate contentKey="groupfaceApp.rating.delete.question" interpolate={{ id: ratingEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-rating" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
