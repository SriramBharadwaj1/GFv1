...
export const EventsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.events.delete.question">
        <Translate contentKey="groupfaceApp.events.delete.question" interpolate={{ id: eventsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-events" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
