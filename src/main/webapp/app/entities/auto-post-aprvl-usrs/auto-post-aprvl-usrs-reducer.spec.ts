...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './auto-post-aprvl-usrs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTOPOSTAPRVLUSRS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTOPOSTAPRVLUSRS actions', async () => {
      const expectedActions = [
        {
