...
const apiSearchUrl = 'api/_search/user-activities';

// Actions

export const searchEntities = createAsyncThunk('userActivity/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
