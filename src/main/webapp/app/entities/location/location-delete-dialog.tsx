...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.location.delete.question">
        <Translate contentKey="groupfaceApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-location" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
