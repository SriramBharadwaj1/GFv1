...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMARKS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_REMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_REMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMARKS actions', async () => {
      const expectedActions = [
        {
