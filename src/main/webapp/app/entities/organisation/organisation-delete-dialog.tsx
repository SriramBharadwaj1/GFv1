...
export const OrganisationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.organisation.delete.question">
        <Translate contentKey="groupfaceApp.organisation.delete.question" interpolate={{ id: organisationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-organisation" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
