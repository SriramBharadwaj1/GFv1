...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-posts-viewed.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPOSTSVIEWED_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERPOSTSVIEWEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERPOSTSVIEWED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERPOSTSVIEWED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERPOSTSVIEWED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERPOSTSVIEWED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERPOSTSVIEWED actions', async () => {
      const expectedActions = [
        {
