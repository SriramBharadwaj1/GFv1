...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGDETAILS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORGDETAILS actions', async () => {
      const expectedActions = [
        {
