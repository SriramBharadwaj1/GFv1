...
import { IGroupUser, defaultValue } from 'app/shared/model/group-user.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROUPUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GROUPUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GROUPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GROUPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GROUPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GROUPUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GROUPUSER actions', async () => {
      const expectedActions = [
        {
