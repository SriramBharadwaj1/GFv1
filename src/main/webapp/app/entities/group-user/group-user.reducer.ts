...
const apiSearchUrl = 'api/_search/group-users';

// Actions

export const searchEntities = createAsyncThunk('groupUser/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
