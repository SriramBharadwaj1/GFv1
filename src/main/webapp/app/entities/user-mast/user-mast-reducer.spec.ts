...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMAST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERMASTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERMAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMAST actions', async () => {
      const expectedActions = [
        {
