...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MASTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MASTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MASTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MASTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MASTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MASTERS actions', async () => {
      const expectedActions = [
        {
