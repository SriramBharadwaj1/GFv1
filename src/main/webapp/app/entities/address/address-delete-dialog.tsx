...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.address.delete.question">
        <Translate contentKey="groupfaceApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-address" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
