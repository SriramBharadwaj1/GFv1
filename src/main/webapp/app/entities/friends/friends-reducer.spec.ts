...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRIENDS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FRIENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FRIENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRIENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRIENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRIENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRIENDS actions', async () => {
      const expectedActions = [
        {
