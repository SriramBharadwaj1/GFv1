...
export const GroupsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="groupfaceApp.groups.delete.question">
        <Translate contentKey="groupfaceApp.groups.delete.question" interpolate={{ id: groupsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="lap-confirm-delete-groups" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
