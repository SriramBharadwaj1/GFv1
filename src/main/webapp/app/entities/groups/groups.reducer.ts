...
import { IGroups, defaultValue } from 'app/shared/model/groups.model';
...
const apiSearchUrl = 'api/_search/groups';

// Actions

export const searchEntities = createAsyncThunk('groups/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
