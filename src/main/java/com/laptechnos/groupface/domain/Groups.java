...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "groups")
...
public class Groups implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "orgIdObj" }, allowSetters = true)
    private UserMast approvedByser;
    ...
    public Groups activitysId(Integer activitysId) {
        this.setActivitysId(activitysId);
        return this;
    }
    ...
    public Groups groupType(Integer groupType) {
    ...
    public Groups isActive(Integer isActive) {
    ...
    public Groups isEnable(Integer isEnable) {
    ...
    public Groups addedBy(Long addedBy) {
    ...
    public Groups addedOn(LocalDate addedOn) {
    ...
    public Groups updatedBy(Long updatedBy) {
    ...
    public Groups updatedOn(LocalDate updatedOn) {
    ...
    public Groups approvedBy(Long approvedBy) {
    ...
    public Groups approvedOn(LocalDate approvedOn) {
    ...
    public Groups comments(String comments) {
    ...
    public Groups remarks(String remarks) {
    ...
    public Groups orgId(Long orgId) {
        this.setOrgId(orgId);
        return this;
    }
    ...
    public Groups validFrom(LocalDate validFrom) {
    ...
    public Groups validTill(LocalDate validTill) {
    ...
    public Groups addedByUser(UserMast userMast) {
    ...
    public Groups updatedByUser(UserMast userMast) {
        this.setUpdatedByUser(userMast);
        return this;
    }

    public UserMast getApprovedByser() {
        return this.approvedByser;
    }

    public void setApprovedByser(UserMast userMast) {
        this.approvedByser = userMast;
    }

    public Groups approvedByser(UserMast userMast) {
        this.setApprovedByser(userMast);
        return this;
    }
    ...
    public Groups orgIdObj(Organisation organisation) {
