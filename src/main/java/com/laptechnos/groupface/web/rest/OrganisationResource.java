...
import com.laptechnos.groupface.service.OrganisationService;
...
/**
 * REST controller for managing {@link com.laptechnos.groupface.domain.Organisation}.
 */
@RestController
@RequestMapping("/api")
public class OrganisationResource {
    ...
    public ResponseEntity<List<OrganisationDTO>> getAllOrganisations(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<List<OrganisationDTO>> searchOrganisations(
