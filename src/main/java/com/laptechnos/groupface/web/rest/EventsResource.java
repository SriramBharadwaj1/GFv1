...
/**
 * REST controller for managing {@link com.laptechnos.groupface.domain.Events}.
 */
@RestController
@RequestMapping("/api")
public class EventsResource {
    ...
    public ResponseEntity<List<EventsDTO>> getAllEvents(
        ...
        Page<EventsDTO> page;
        if (eagerload) {
            page = eventsService.findAllWithEagerRelationships(pageable);
        } else {
            page = eventsService.findAll(pageable);
        }
