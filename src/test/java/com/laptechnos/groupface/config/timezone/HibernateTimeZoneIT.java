package com.laptechnos.groupface.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.laptechnos.groupface.IntegrationTest;
import com.laptechnos.groupface.repository.timezone.DateTimeWrapper;
import com.laptechnos.groupface.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM lap_date_time_wrapper where id=%d", fieldName, id);
    }
